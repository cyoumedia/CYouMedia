...
/* ─────────────────────────────────────────
   PARTICLES — static deterministic data (no Math.random → SSR-safe)
───────────────────────────────────────── */
const PARTICLE_DATA = [
...
/* ─────────────────────────────────────────
   OPERATE ROW — Card & Text as named components (not inline)
   to prevent React from unmounting/remounting on each render
───────────────────────────────────────── */
...
const OperateText = ({ title, body, index, reverse }) => (
  ...
  >
    ...
    <motion.h3
      ...
      className="text-[clamp(1.9rem,3.2vw,2.8rem)] font-bold tracking-[-0.03em] leading-[1.1] text-[#0a0a0a]"
    >
      {title}
    </motion.h3>
    <motion.p
      ...
      className="text-[#777] text-[17px] font-light leading-[1.82] max-w-md"
    >
      {body}
    </motion.p>
    <motion.div
...
const ServiceCard = ({ service, index, total }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-stretch min-h-[290px] sm:min-h-[330px]">
        {/* Number column */}
        <div className={`hidden lg:flex items-center justify-center w-28 xl:w-36 shrink-0 border-r ${isDark ? "border-white/[0.06]" : "border-black/[0.06]"}`}>
          <motion.span
        ...
        {/* Content */}
        <div className="flex-1 flex flex-col justify-between p-8 sm:p-10 lg:p-12">
          ...
          <div className="flex-1 flex flex-col justify-center gap-5">
            <h3 className={`font-bold tracking-[-0.03em] leading-[1.06] ${isDark ? "text-white" : "text-[#0a0a0a]"}`} style={{ fontSize: "clamp(1.6rem, 3vw, 2.8rem)" }}>
              {service.heading}
            </h3>
            <p className={`text-[16px] font-light leading-[1.82] max-w-lg ${isDark ? "text-white/50" : "text-[#666]"}`}>
              {service.body}
            </p>
          </div>
          <motion.div
          ...
          >
            <span className={`text-[11px] font-bold tracking-[0.2em] uppercase ${isDark ? "text-white/28" : "text-[#aaa]"}`}>{service.label}</span>
            <motion.div
        ...
        {/* Tags column */}
        <div className={`hidden lg:flex flex-col justify-center gap-3 w-44 xl:w-52 shrink-0 p-8 border-l ${isDark ? "border-white/[0.06]" : "border-black/[0.06]"}`}>
          {service.tags.map((tag, ti) => (
            <motion.span
              ...
              className={`text-[10px] font-semibold tracking-[0.16em] uppercase px-3 py-2.5 rounded-xl border ${
      ...
      {/* Mobile tags */}
      <div className="lg:hidden flex flex-wrap gap-2 px-8 pb-8">
        {service.tags.map((tag) => (
          <span key={tag} className={`text-[10px] font-semibold tracking-[0.14em] uppercase px-3 py-1.5 rounded-full border ${isDark ? "border-white/10 text-white/32 bg-white/[0.04]" : "border-[#e0e0e0] text-[#666] bg-white"}`}>
            {tag}
          </span>
        ))}
      </div>
...
export default function Home() {
  ...
  const services = [
    {
      ...
      heading: "The legal & commercial foundation for real growth.",
    ...
    },
    {
      ...
      heading: "Your business, found by the right people — every time.",
  ...
  const operateItems = [
    ...
    { title: "Security Through Structure", body: "All our collaborations rest on solid legal foundations. Our agreements are designed to protect both our partners and ourselves from day one.", imgSrc: "/02.png" },
  ...
  return (
    <div className="bg-white text-[#0a0a0a] overflow-x-hidden" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <section ref={heroRef} className="relative w-full h-screen min-h-[640px] overflow-hidden flex items-center justify-center bg-black">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-20 text-center px-5 max-w-5xl mx-auto w-full">
          ...
          <div className="overflow-hidden mb-7 sm:mb-9">
            <motion.h1
              ...
              className="text-[clamp(3rem,9vw,8rem)] font-bold tracking-[-0.038em] leading-[0.98] text-white"
          ...
          <motion.p
            ...
            className="text-white/55 text-base sm:text-lg md:text-xl font-light max-w-lg mx-auto mb-12 sm:mb-16 leading-relaxed px-2"
          >
          ...
          >
            <Magnetic>
              <Link href="/contact" className="inline-flex items-center justify-center gap-2.5 bg-white text-[#0a0a0a] text-[13px] font-bold px-8 py-4 rounded-full hover:bg-white/92 active:scale-95 transition-all duration-200">
                Start Your Growth
                <motion.svg
      ...
      {/* ══ 2 ▸ WHO WE ARE ══ */}
      <section id="about" className="py-15 max-w-[1440px] mx-auto">
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-24 items-end mb-14 sm:mb-16">
          <motion.div
          ...
          >
            <Tag>Who We Are</Tag>
            <h2 className="text-[clamp(2.8rem,5.6vw,5.8rem)] font-bold tracking-[-0.036em] leading-[1.02]">
              Business<br />
              <motion.span
          ...
          >
            <p className="text-[#666] text-[17px] font-light leading-[1.85]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_340px] lg:grid-cols-[1fr_380px] gap-4">
          <motion.div
          ...
          >
            ...
            <div className="absolute bottom-0 inset-x-0 p-7 z-10" style={{ background: "linear-gradient(to top, rgba(10,10,10,0.55) 0%, transparent 100%)" }}>
              <p className="text-white/60 text-[10px] font-bold tracking-[0.22em] uppercase">Our Team</p>
            </div>
          </motion.div>
          ...
          <div className="flex sm:flex-col gap-4">
            <motion.div
              ...
              className="flex-1 sm:flex-none rounded-3xl p-7 flex flex-col overflow-hidden relative"
              style={{ minHeight: "220px", background: "linear-gradient(135deg, #0d0d0d 0%, #1c1c1c 100%)" }}
            >
              ...
              <p className="text-[9px] font-bold tracking-[0.24em] uppercase text-white/20 mb-6 relative z-10">At a glance</p>
              <div className="flex flex-col gap-0 relative z-10 mt-auto">
                {[{ n: "6+", l: "Global Hubs" }, { n: "10M+", l: "Growth Target" }, { n: "100%", l: "Results Driven" }].map(({ n, l }, i) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between py-4 border-t border-white/[0.07] first:border-0"
                  >
                    <span className="text-[10px] font-semibold tracking-[0.16em] uppercase text-white/28">{l}</span>
                    <span className="text-[1.65rem] font-bold text-white tracking-tight tabular-nums">{n}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex-1 sm:flex-none bg-[#f5f5f5] rounded-3xl p-7 flex flex-col justify-between"
              style={{ minHeight: "160px" }}
            >
              <span className="text-[2.2rem] text-[#ddd] leading-none select-none font-serif">"</span>
              <p className="text-[15px] font-semibold text-[#0a0a0a] leading-[1.58] tracking-[-0.01em]">
                If you exist —<br />you are seen.
              </p>
              <p className="text-[9px] font-bold tracking-[0.24em] uppercase text-[#bbb] mt-3">CYouMedia Principle</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      {/* ══ 3 ▸ SERVICE CORE ══ */}
      <section id="services" className="pt-28 sm:pt-40 pb-28 sm:pb-36 px-5 md:px-10 lg:px-20 max-w-[1440px] mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-20 sm:mb-24">
          <div>
            ...
            <div className="overflow-hidden">
              <motion.h2
                ...
                viewport={{ once: true }}
                transition={{ duration: 1, ease: EASE_EXPO }}
                className="text-[clamp(3.2rem,6.5vw,7rem)] font-bold tracking-[-0.04em] leading-[0.95]"
              >
                Service<br />
          ...
          <motion.p
            ...
            className="text-[#999] text-[14px] font-light leading-relaxed max-w-xs sm:text-right sm:pb-2"
          >
      ...
      <section ref={globalRef} id="reach" className="relative overflow-hidden" style={{ minHeight: "92vh" }}>
        ...
        <div className="relative z-20 px-5 md:px-10 lg:px-20 pt-28 sm:pt-36 pb-52 sm:pb-60 max-w-[1440px] mx-auto">
          ...
          >
            ...
            <h2 className="text-[clamp(3rem,7vw,7rem)] font-bold tracking-[-0.035em] leading-[1.02] text-white" style={{ textShadow: "0 8px 60px rgba(0,0,0,0.6)" }}>
              Global Reach
              <br />
              <span className="font-extralight text-white/48">&amp; Expertise</span>
            </h2>
            <p className="mt-7 text-white/80 text-base sm:text-lg font-light max-w-lg leading-relaxed" style={{ textShadow: "0 2px 16px rgba(0,0,0,0.5)" }}>
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-30 w-full max-w-5xl px-5">
          <div className="flex items-center gap-8 lg:gap-14 flex-wrap justify-center">
            {[
              ...
              >
                <p className="text-black font-bold text-sm sm:text-base">{loc.name}</p>
      ...
      {/* ══ 5 ▸ HOW WE OPERATE ══ */}
      <section className="pt-6 pb-32 sm:pb-44 px-5 md:px-10 lg:px-20 max-w-[1440px] mx-auto">
        <div className="border-t border-[#f0f0f0] pt-24 sm:pt-32">
          <Tag>Our Workflow</Tag>
          <div className="overflow-hidden mb-24 sm:mb-32">
            <motion.h2
              initial={{ y: "100%", opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 1, ease: EASE_EXPO }}
              className="text-[clamp(2.4rem,4.5vw,4.2rem)] font-bold tracking-[-0.034em] leading-tight"
            >
              How We Operate.
            </motion.h2>
          </div>
          <div className="flex flex-col gap-24 sm:gap-32 md:gap-44">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 1, ease: EASE_EXPO }}
            className="mt-24 sm:mt-32 rounded-3xl bg-[#f7f7f7] p-9 sm:p-14 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-10"
          >
            <div>
              <p className="text-[9px] font-bold tracking-[0.26em] uppercase text-[#ccc] mb-4">Elite network</p>
              <p className="text-xl sm:text-2xl md:text-[2rem] font-bold tracking-[-0.026em] max-w-xl leading-tight">
                Professionals connected to Spotify, Swish, and the world's leading markets.
              </p>
            </div>
            <Magnetic>
              <Link href="/contact" className="shrink-0 inline-flex items-center gap-2.5 bg-[#0a0a0a] text-white text-[13px] font-bold px-7 sm:px-9 py-4 rounded-full hover:bg-[#222] active:scale-95 transition-all duration-200 whitespace-nowrap">
                Work With Us
      ...
      {/* ══ 6 ▸ WHY CYOUMEDIA ══ */}
      <section className="pt-4 pb-28 sm:pb-36 px-5 md:px-10 lg:px-20 max-w-[1440px] mx-auto">
        <div className="border-t border-[#f0f0f0] pt-24 sm:pt-32">
          ...
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-start">
            <motion.div
              ...
              transition={{ duration: 1.1, ease: EASE_EXPO }}
            >
              <h2 className="text-[clamp(2.3rem,4.8vw,4.8rem)] font-bold tracking-[-0.036em] leading-[1.06]">
                Business is not<br />about complexity —<br />
                <span className="text-[#c8c8c8]">it's about results.</span>
              </h2>
              <p className="mt-9 text-[#666] text-[17px] font-light leading-[1.82] max-w-md">
              ...
              >
                <Magnetic>
                  <Link href="/contact" className="inline-flex items-center gap-2.5 bg-[#0a0a0a] text-white text-[13px] font-bold px-8 py-4 rounded-full hover:bg-[#222] active:scale-95 transition-all duration-200">
                    Start Your Growth
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                  </Link>
                </Magnetic>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <motion.div
                  ...
                  className="bg-[#f7f7f7] rounded-3xl p-7 flex flex-col gap-4 cursor-default"
                >
                  <motion.span
                    animate={{ rotate: [0, 10, 0] }}
                    transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: i * 0.8 }}
                    className="text-2xl text-[#d0d0d0] block"
                  >
                    {item.icon}
                  </motion.span>
                  <p className="text-[15px] font-bold leading-tight">{item.title}</p>
                  <p className="text-[13px] text-[#999] font-light leading-relaxed">{item.body}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      {/* ══ 7 ▸ CTA ══ */}
      <section id="contact" className="px-5 md:px-10 lg:px-20 pb-20 sm:pb-24 max-w-[1440px] mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 48, filter: "blur(12px)" }}
          whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          viewport={{ once: true }}
          transition={{ duration: 1.1, ease: EASE_EXPO }}
          className="rounded-3xl bg-[#080808] px-8 sm:px-14 py-16 sm:py-20 text-center relative overflow-hidden"
        >
          <motion.div
          ...
          <motion.p
            ...
            className="text-[9px] font-bold tracking-[0.34em] uppercase text-white/18 mb-6 relative z-10"
          >
            CYouMedia
          </motion.p>
          ...
          <motion.div
            ...
            className="relative z-10 inline-flex items-center gap-4 mb-5"
          >
            ...
            <h2 className="text-[clamp(1.5rem,3.2vw,2.9rem)] font-bold tracking-[-0.022em]" style={{ color: "#ffff", textShadow: "0 0 50px rgba(137,207,241,0.32)" }}>
          ...
          <motion.p
            ...
            className="relative z-10 text-white/30 text-[13px] font-light tracking-[0.06em] mb-10"
          >
          ...
          >
            <Magnetic>
              <Link href="/contact" className="inline-flex items-center gap-2.5 bg-white text-[#0a0a0a] text-[13px] font-bold px-8 py-4 rounded-full hover:bg-white/90 active:scale-95 transition-all duration-200">
                Start Your Growth
                <motion.svg
                  className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                  animate={{ x: [0, 4, 0] }}
